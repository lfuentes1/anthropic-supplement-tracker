...
const VitaminRow = ({ nutrient, onUpdate, onDelete }: VitaminRowProps) => {
  ...
  const handleNameChange = (value: string) => {
    ...
    // Filter FDA suggestions based on input - include both vitamins and minerals
    ...
    <div className="flex items-center space-x-2">
      <div className="relative flex-1">
        <Input
          ...
          onFocus={() => {
            // Show all FDA values when focused if input is empty
            if (!nutrient.name.trim()) {
              setFilteredSuggestions(FDA_DAILY_VALUES);
          ...
          placeholder="Vitamin or Mineral name"
        />
        ...
        {showSuggestions && (
          ...
          >
            {/* Group vitamins and minerals separately for better organization */}
